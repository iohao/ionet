...
final class DefaultBreakingNews implements BreakingNews {
    ...
    public List<News> listMainNews() {
        return List.of(
                ...
                new News("ionet 框架各版本更新日志", "https://iohao.github.io/ionet/docs/version_log"),
                new News("ionet 发版本的频率：每月会发 1 ~ 2 个版本，通常在大版本内的升级总是兼容的", "")
        );
    }
    ...
    public List<News> listAdv() {
        return List.of(
                ...
                new News("桌游类、房间类的实战", "https://iohao.github.io/ionet/docs/practices/room_in_action")
        );
    }
    ...
    public List<News> listNews() {
        ...
        list.add(new News("支持者名单", "https://iohao.github.io/ionet/docs/contribute/backers"));

        // 开发常见问题与小技巧
        list.add(new News("全链路调用日志跟踪", "https://iohao.github.io/ionet/docs/manual/trace"));

        // 授权相关、实践类产品
        list.add(new News("项目成本分析", "https://iohao.github.io/ionet/services/cost_analysis"));

        // 整体、架构相关
        list.add(new News("架构简介", "https://iohao.github.io/ionet/docs/overall/architecture_intro"));
        list.add(new News("ionet 架构灵活、部署多样性", "https://iohao.github.io/ionet/docs/overall/deploy_flexible"));
        list.add(new News("与传统架构的对比", "https://iohao.github.io/ionet/docs/overall/legacy_system"));

        list.add(new News("ionet 请求的处理流程", "https://iohao.github.io/ionet/docs/overall/request_processing_procedure"));
        list.add(new News("ionet 线程相关", "https://iohao.github.io/ionet/docs/overall/thread_executor"));
        list.add(new News("单服单进程、多服单进程、多服多进程的启动方式", "https://iohao.github.io/ionet/docs/manual/netty_run_one"));
        list.add(new News("代码组织与约定", "https://iohao.github.io/ionet/docs/manual_high/code_organization"));
        list.add(new News("同进程亲和性", "https://iohao.github.io/ionet/docs/manual_high/same_process"));

        // 逻辑服
        list.add(new News("逻辑服 - 动态绑定逻辑服", "https://iohao.github.io/ionet/docs/manual/binding_logic_server"));
        list.add(new News("逻辑服 - 元信息、附加信息", "https://iohao.github.io/ionet/docs/manual/flowcontext_attachment"));

        // 对外服
        list.add(new News("对外服 - 统一协议说明", "https://iohao.github.io/ionet/docs/manual_high/external_message"));
        list.add(new News("对外服", "https://iohao.github.io/ionet/docs/overall/external_intro"));
        list.add(new News("对外服 - 心跳设置与心跳钩子", "https://iohao.github.io/ionet/docs/external/idle"));
        list.add(new News("对外服 - 用户上线、下线钩子", "https://iohao.github.io/ionet/docs/external/user_hook"));
        list.add(new News("对外服 - 路由访问权限控制", "https://iohao.github.io/ionet/docs/external/access_authentication"));
        list.add(new News("对外服 - 对外服缓存", "https://iohao.github.io/ionet/docs/external/cache"));
        list.add(new News("对外服 - ws token 鉴权、校验", "https://iohao.github.io/ionet/docs/external/ws_verify"));
        list.add(new News("对外服 - 内置与可选的 Handler", "https://iohao.github.io/ionet/docs/external/netty_handler"));

        // 通讯方式
        list.add(new News("通讯方式 - 请求同类型多个逻辑服通信结果", "https://iohao.github.io/ionet/docs/communication/request_multiple_response"));
        list.add(new News("通讯方式 - 访问对外服与扩展", "https://iohao.github.io/ionet/docs/communication/external_biz_region"));
        list.add(new News("通讯方式 - 分布式事件总线", "https://iohao.github.io/ionet/docs/communication/event_bus"));

        // 内置工具
        list.add(new News("内置 Kit - TaskKit 是一个任务、时间、延时监听、超时监听...等相结合的一个工具模块", "https://iohao.github.io/ionet/docs/kit/task_kit"));
        list.add(new News("内置 Kit - 属性监听", "https://iohao.github.io/ionet/docs/kit/property_change_listener"));
        list.add(new News("内置 Kit - 轻量可控的延时任务", "https://iohao.github.io/ionet/docs/kit/delay_task"));

        // 扩展模块
        list.add(new News("扩展模块 - 领域事件可解决多人同一业务的并发问题", "https://iohao.github.io/ionet/docs/extension_module/domain_event"));
        list.add(new News("扩展模块 - 压测&模拟客户端请求", "https://iohao.github.io/ionet/docs/extension_module/simulation_client"));
        list.add(new News("扩展模块 - room 桌游、房间类的扩展模块", "https://iohao.github.io/ionet/docs/extension_module/room"));
        list.add(new News("扩展模块 - sdk-generate-code", "https://iohao.github.io/ionet/docs/extension_module/generate_code"));

        // 插件相关
        list.add(new News("业务框架 - 插件介绍", "https://iohao.github.io/ionet/docs/manual/plugin_intro"));
        list.add(new News("插件 - DebugInOut 插件", "https://iohao.github.io/ionet/docs/core_plugin/action_debug"));
        list.add(new News("插件 - action 调用统计插件", "https://iohao.github.io/ionet/docs/core_plugin/action_stat"));
        list.add(new News("插件 - 业务线程监控插件", "https://iohao.github.io/ionet/docs/core_plugin/action_thread_monitor"));
        list.add(new News("插件 - 各时间段调用统计插件", "https://iohao.github.io/ionet/docs/core_plugin/action_time_range"));
        list.add(new News("插件 - 全链路调用日志跟踪", "https://iohao.github.io/ionet/docs/core_plugin/action_trace"));

        // 业务框架
        list.add(new News("业务框架 - 简介", "https://iohao.github.io/ionet/docs/core/framework"));
        list.add(new News("业务框架 - FlowContext", "https://iohao.github.io/ionet/docs/manual/flowcontext"));
        list.add(new News("业务框架 - 断言 + 异常机制 = 清晰简洁的代码", "https://iohao.github.io/ionet/docs/manual/assert_game_code"));
        list.add(new News("业务框架 - 开启 JSR380 验证规范", "https://iohao.github.io/ionet/docs/core/jsr380"));
        list.add(new News("业务框架 - 解决协议碎片", "https://iohao.github.io/ionet/docs/manual/protocol_fragment"));

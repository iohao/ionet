...
- [Module and Source Map](source-map.md) - Practical ownership map for ionet's 15 Maven modules, core entrypoints, SPI resources, tests, and cross-module change hotspots.
